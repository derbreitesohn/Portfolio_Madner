  ...
  return (
    <footer className="w-full py-24 border-t border-white/5 mt-32">
      <div className="max-w-6xl mx-auto px-6 flex flex-col gap-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 w-full items-center gap-8 md:gap-0">
          
          {/* Logo Section - Left on desktop, center on mobile */}
          <div className="text-xl font-black tracking-tighter text-white text-center md:text-left">
            MADNER<span className="text-gray-500">.</span>
          </div>

          {/* Social Links - ABSOLUTE CENTER */}
        ...
        <div className="text-center w-full pt-8 border-t border-white/[0.02]">
          <p className="text-[10px] uppercase tracking-[0.5em] font-black text-gray-700">
