...
// lucide dropped its brand icons, so the two marks live here rather than pulling in a second icon package.
const marks = {
  github:
      ...
      <div className="portfolio-width">
        <div className="portfolio-contact">
          <div>
            ...
            <a href={`mailto:${personalInfo.email}`} className="portfolio-email">{personalInfo.email}</a>
          </div>
        </div>
