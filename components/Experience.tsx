...
export default function Experience() {
  return (
    <section id="experience" className="grid grid-cols-1 lg:grid-cols-3 gap-16 border-t border-gray-900 pt-20">
      <div>
      ...
      <div className="lg:col-span-2 space-y-12">
        {CV_DATA.map((item, i) => (
          <motion.div 
            ...
            className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-900 pb-8 last:border-0"
          >
